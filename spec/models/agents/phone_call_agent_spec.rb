...
describe Agents::PhoneCallAgent do
    before do
        default_options = {
        ...
        @checker = Agents::PhoneCallAgent.new name: 'Phone Call Tester', options: default_options
    ...
    def stub_methods
        stub.any_instance_of(Agents::PhoneCallAgent).make_phone_call do |params|
